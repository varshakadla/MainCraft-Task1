...
Task Description
Your first challenge is to create a beautiful, modern landing page using HTML5 & CSS3
only. Think of it like a mini portfolio piece — something that looks professional, clean, and
responsive.
...
Hero Section (First Impression Zone )
o Big heading + short catchy tagline
...
o Responsive design (mobile view works well)
